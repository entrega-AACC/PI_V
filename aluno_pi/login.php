            ...
            <div class="col-lg-6">
              <div class="card-body p-md-5 mx-md-4">
                ...
                <form>
                  ...
                  <div class="text-center pt-1 mb-5 pb-1"><a href="aluno_pi.php">
                    <button href="aluno_pi.php" class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3"  value="Entrar" type="button"> 
    Entrar</button></a>
