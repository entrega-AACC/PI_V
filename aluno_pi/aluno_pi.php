...
include_once('conexao.php');
  ...
  $result = mysqli_query($mysqli, "INSERT INTO dados_alunos_aacc(COD_ATVD_ALUNO, RA) VALUES ('$cod', '$ra')");
}
          ...
          <div class="card-body card-body-padding d-flex align-items-center justify-content-between">
            <div class="ps-lg-1">
              <div class="d-flex align-items-center justify-content-between">
                ...
                <a href="https://www.bootstrapdash.com/product/purple-bootstrap-admin-template/?utm_source=organic&utm_medium=banner&utm_campaign=buynow_demo" target="_blank" class="btn me-2 buy-now-btn border-0">Painel Aluno</a>
              </div>
            </div>
            <div class="d-flex align-items-center justify-content-between">
          ...
          <div class="content-wrapper">
              ...
              <nav aria-label="breadcrumb">
                <ul class="breadcrumb">
                  <li class="breadcrumb-item active" aria-current="page">
                    <span></span>Atividades <i class="mdi mdi-alert-circle-outline icon-sm text-primary align-middle"></i>
                  </li>
                </ul>
              </nav>
            </div>
            ...
            <div class="row">
              <div class="col-6 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Registrar Atividade</h4>
  ...
  <div class="col-12 grid-margin">
    ...
    <div class="col">
      <div class="form-outline">
        ...
        <label class="form-label" for="form6Example2">Anexo</label>
      </div>
    </div>
  </div>
...
<div class="col-6 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Pesquisar Atividades</h4>
...
$sql = mysqli_query($cx, "SELECT * FROM atividade") or die( 
...
echo"
  <tr>
  <td>$aux[COD_ATIVIDADE]</td>
  <th> </th>
  <th> </th>
  <td>$aux[NOME_ATIVIDADE]</td>
  <th> </th>
  <td>$aux[ANEXO]</td>
  <th> </th>

  <td>$aux[DESC_ATIVIDADE]</td>
  <th> </th>
  <td>$aux[VALOR_HORA]</td>
  <th> </th>
  <td>
    <a class='btn btn-primary btn-sm'> Cadastrar </a>
